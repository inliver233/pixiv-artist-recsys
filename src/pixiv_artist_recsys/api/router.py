        ...
        if path == '/recommend/full':
            ...
            return ApiResponse(
                ...
                payload=self.application.full_recommend_payload(
                    ...
                    followed_artist_limit=self._optional_body_int(body, 'followed_artist_limit', default=8) or 8,
                    candidate_artist_limit=self._optional_body_int(body, 'candidate_artist_limit', default=5) or 5,
                    ...
                    max_user_recommended=self._optional_body_int(body, 'max_user_recommended', default=30) or 30,
                    enable_tag_search=self._optional_body_bool(body, 'enable_tag_search', default=True),
                    max_tag_search_tags=self._optional_body_int(body, 'max_tag_search_tags', default=5) or 5,
                    max_tag_search_illusts=self._optional_body_int(body, 'max_tag_search_illusts', default=20) or 20,
                    top_n_tags=self._optional_body_int(body, 'top_n_tags', default=20) or 20,
                    top_n_pairs=self._optional_body_int(body, 'top_n_pairs', default=20) or 20,
