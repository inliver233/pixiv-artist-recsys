        ...
        if path == '/recommend/from-store':
            ...
            return ApiResponse(
                ...
                payload=self.application.recommend_from_store_payload(
                    ...
                    min_local_illusts=self._query_int(
                        request,
                        'min_local_illusts',
                        default=self.runtime.settings.recommendation.min_local_illusts,
                    ),
                    require_tag_overlap=self._query_bool(
                        request,
                        'require_tag_overlap',
                        default=self.runtime.settings.recommendation.require_tag_overlap,
                    ),
                    max_genre_fraction=self._query_float(
                        request,
                        'max_genre_fraction',
